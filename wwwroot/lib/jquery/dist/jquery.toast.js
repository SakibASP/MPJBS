...
(function ($, window, document, undefined) {
    ...
    var Toast = {
        ...
        setup: function () {
            ...
            if (this.options.bgColor) {
                ...
                _toastEl.css("border-color", this.options.borderColor);
    ...
    $.toast = function ({ heading, text, type, hideAfter }) {
        var options = {
            text: text ? text : '',
            heading: heading ? heading : '',
            showHideTransition: 'fade',
            allowToastClose: true,
            hideAfter: hideAfter ? hideAfter : 5000,
            bgColor: type === 'success' ? '#c8e5bc' :
                type === 'info' ? '#b9def0' :
                    type === 'warning' ? '#f8efc0' :
                        type === 'error' ? '#e7c3c3' : '#b8f8fc',
            borderColor: type === 'success' ? '#b2dba1' :
                type === 'info' ? '#9acfea' :
                    type === 'warning' ? '#f5e79e' :
                        type === 'error' ? '#dca7a7' : '#008C8C',
            textColor: type === 'success' ? '#3c763d' :
                type === 'info' ? '#31708f' :
                    type === 'warning' ? '#8a6d3b' :
                        type === 'error' ? '#a94442' : '#008C8C'
        };
